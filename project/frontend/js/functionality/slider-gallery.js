...
export default class Gallery {
  ...
  setParameters() {
    const coordLineContainer = this.lineContainerNode.getBoundingClientRect();
    this.width = coordLineContainer.width;
  ...
  setEvents() {
    this.debouncedResizeGalerry = debounce(this.resizeGallery);
    window.addEventListener('resize', this.debouncedResizeGalerry);
  ...
  destroyEvents() {
    window.removeEventListener('resize', this.debouncedResizeGalerry);
